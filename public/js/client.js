(async function init() {
    ...
    document.getElementById('name').textContent = user.name ? user.name : 'Raju Melveetilpurayil';
    document.getElementById('email').textContent = user.email ? user.email : 'raju.m@example.com';
...
function updateProfile() {
    ...
    document.getElementById('input-name').text = document.getElementById('name').textContent;
